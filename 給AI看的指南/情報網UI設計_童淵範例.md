...
> ⚠ 2026-08-29 對齊：童淵情報歸**立地太歲**（山林、武人），客棧夜影歸**鼓上蚤**——以 `劇情/探險事件提示.md` 及其附錄索引為準；本檔是早期稿，原本寫浪裡白條（水性）是錯的。
...
*   **[右側詳情]** (根據左側選中的條目，動態切換內容)
    *   **圖片：** (切換為童淵相關圖片)
    *   **靈犀筆記：** 「立地太歲說，那個人在那邊練槍好半天了，看起來很厲害。表哥你不是一直想找人切磋嗎？要不要去會會他？」
    *   **按鈕：** `[立刻前往 (消耗 5 點)]`
...
*   **[右側詳情]** (當玩家點擊左側的 🔴 `[城鎮]` 時)
    ...
    *   **情報清單：** (原本顯示「消耗行動點8點」的地方，改為列出該區域當前的所有事件)
        *   `[立地太歲 報] 童淵的煩惱 (消耗 5 點)` `[前往]`
        *   `[鼓上蚤 報] 客棧夜影 (消耗 9 點)` `[前往]`
