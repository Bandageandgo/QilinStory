...
**(若選擇1: 「試試解這殘局。」)**
    ...
    **（互動觸發小遊戲：兵法小遊戲）**
    *   **成功**：A級評價。
        **Sequence ModifyData(FeatExp,MC1,MilitaryTactics,20);** // 假設 MilitaryTactics 是兵法檢定對應的專長ID
        **旁白:**：[PANEL=6]＊（你成功解開殘局！雖只是遊戲，亦感精神一振。）＊
        `蕭靈犀` `[星星眼]`：「哇！表哥你好厲害！但這破紙片…能賣錢嗎？看起來很舊了。」 
        **Sequence SetPortrait(MC8,pic=happy);EnableCharacterExpression(1,MC8,Surprise_2);**
        **旁白**：[PANEL=6]＊（你對此棋局的解法已瞭然於胸）＊
        **Description 獲得概念上的【棋譜殘頁】** // 標記玩家已解開棋局，獲得「棋譜殘頁」的概念
        **Sequence DisableCharacterExpression(1);** // 關閉蕭靈犀的表情
        // 設置一個遊戲內變數/標記，表明棋局已解開，例如：GameFlag_ChessPuzzleSolved = true
...
**村長 (NPC2):** `[嗓門洪亮，豪爽立繪]`：「喲！哪來的年輕人？面生得很啊！歡迎歡迎！」
**蕭靈犀:** `[上前一步，禮貌但直接]`：「村長好，我們是路過旅人。聽聞此地前往英豪府的馬車，似乎要等上一個月才能出發？」
**Sequence SetPortrait(MC8,pic=expect);EnableCharacterExpression(1,MC8,Question);**
**村長 (NPC2):** `[點頭，聲音響亮]`：「唉，姑娘消息靈通！確實如此。近來山頭不太平，鬧山賊，縣衙下了文，為了大家夥兒的安全，驛站的馬車得等一個月後才能通行。」 `[目光掃過兩人，咧嘴一笑]`：「看你們倆風塵僕僕…莫不是急著趕路，又為這一個月的食宿盤纏發愁吧？」
**Sequence DisableCharacterExpression(1);SetPortrait(NPC2,pic=knowing_smile);** // 假設村長有對應立繪
**燕不凡:** `[尷尬立繪，試圖挺直腰板]`：「呃…村長慧眼。我等確有此憂慮，大丈夫一文錢難倒英雄漢，也是常事…咕…」
**Sequence SetPortrait(MC1,pic=Shy);EnableCharacterExpression(0,MC1,Nervous);**
**村長 (NPC2):** `[哈哈大笑，拍燕不凡肩膀]`：「哈哈哈！好說！年輕人出門在外，手頭緊正常！有什麼不好意思的！」 `[大手一揮]`：「放心！咱村活計有的是！肯賣力氣，一個月的食宿不成問題！就看你們想不想幹！」
**Sequence DisableCharacterExpression(0);SetPortrait(NPC2,pic=hearty_laugh);** // 假設村長有對應立繪

**玩家**（選擇回應）：
1.  「請村長指點，有何差事？」
2.  「除了盤纏，此村可有值得遊俠一探的奇聞？」
3.  「聽聞村中規矩，我等初來，望村長告知一二。」
4.  **(若先前成功解開石桌棋局)** 「村長，晚輩曾在村口石桌見一未完棋局，並對其解法略有所得，不知村長對棋藝是否亦有涉獵？」

**(若選擇1: 「請村長指點，有何差事？」)**
    **燕不凡:**：「還請村長指點一二，有何差事可做？在下願效勞！」
    **Sequence SetPortrait(MC1,pic=serious);**
    **村長 (NPC2):** `[點頭贊許]`：「哈哈，有幹勁！村東郎中常缺人採藥；村西牧羊人羊多；怪學究給錢大方。你們自個兒去問問！」
    **Sequence SetPortrait(NPC2,pic=approving);** // 假設村長有對應立繪
    // [返回玩家選項] (此處根據遊戲實際流程決定是返回還是結束對話)

**(若選擇2: 「除了盤纏，此村可有值得遊俠一探的奇聞？」)**
    **燕不凡:**：「敢問村長，除了盤纏之事，此村可有什麼值得我等遊俠一探究竟的奇聞異事？」
    **Sequence SetPortrait(MC1,pic=proud);EnableCharacterExpression(0,MC1,Question);**
    **村長 (NPC2):** `[摸下巴]`：「奇聞？我們村風調雨順就是最大奇聞！風景嘛…村後小溪可釣魚，運氣好能釣上大家伙！」
    **Sequence DisableCharacterExpression(0);SetPortrait(NPC2,pic=thoughtful);** // 假設村長有對應立繪
    **蕭靈犀:** `[眼睛一亮]`：「釣魚？能賣錢嗎？」
...
**(若選擇3: 「聽聞村中規矩，我等初來，望村長告知一二。」)**
    **燕不凡:**：「我等初來貴地，還望村長告知一二村中規矩，免得無意中有所冒犯。」
    **Sequence SetPortrait(MC1,pic=serious);EnableCharacterExpression(0,MC1,Question);**
    **村長 (NPC2):** `[表情略嚴肅]`：「規矩嘛，簡單。天黑前回屋，別去河邊瞎逛。別進沒請你進的門。哦對了，」 `[眼神閃爍]`：「晚上聽到怪聲音…就當沒聽見，睡你的覺，懂嗎？」
    **Sequence DisableCharacterExpression(0);SetPortrait(NPC2,pic=serious_subtle);** // 假設村長有對應立繪
    **燕不凡:** `[皺眉]`：「怪聲音？」
    **Sequence SetPortrait(MC1,pic=mindpain);EnableCharacterExpression(0,MC1,Question);**
    **燕不凡:** `[低聲碎碎念立繪]`：「果然有問題…」
    **Sequence DisableCharacterExpression(0);SetPortrait(MC1,pic=tired);EnableCharacterExpression(0,MC1,Meditate);**
    **Sequence DisableCharacterExpression(0);** // 關閉燕不凡的 Meditate 表情
    // [返回玩家選項]

**(若選擇4 (且先前成功解開石桌棋局): 「村長，晚輩曾在村口石桌見一未完棋局，並對其解法略有所得，不知村長對棋藝是否亦有涉獵？」)**
    **燕不凡:**：「村長，晚輩日前在村口石桌旁見到一局未完的棋局，一時技癢，便試著推演了一番，對其解法略有所得。不知村長對棋藝是否亦有涉獵？」
    **Sequence SetPortrait(MC1,pic=serious);**
    **村長 (NPC2):** `[眼睛放光]`：「哦？！年輕人，你說的是大槐樹下那盤棋？那可是《弈星譜》上的殘局！你當真解開了？」
    **Sequence SetPortrait(NPC2,pic=excited);** // 假設村長有對應立繪
    **燕不凡:**：「正是那局。晚輩不才，僥倖參破其中變化。」
    **Sequence SetPortrait(MC1,pic=proud);**
    **村長 (NPC2):** `[激動接過]`：「踏破鐵鞋無覓處啊！年輕人，老朽鑽研那棋局多日，就差臨門一腳！你可願將此解法告知於我？或是有何想法？」
    **Sequence SetPortrait(NPC2,pic=eager);** // 假設村長有對應立繪

**玩家選項** (關於棋局解法)：
    A. 「區區解法，能助村長，晚輩樂意之至。」 (慷慨告知)
    B. 「相逢有緣，村長若需此解法，出個價便可。」 (普通出售)
    C. 「[口才 難度12] 此解法精妙，晚輩也是費了番心神。看村長也是愛棋之人，不知村長願出何價交換？」 (口才試探)
    D. 「不了，此解法精妙，晚輩還想自行參詳一番。」 (保留)

**(若選擇A: 「區區解法，能助村長，晚輩樂意之至。」)**
        **燕不凡:**：「區區棋局解法，能助村長完善棋譜，實乃它的榮幸。晚輩願將心得與村長共享。」
        **Sequence SetPortrait(MC1,pic=proud);**
        **村長 (NPC2):** `[大喜立繪]`：「好好好！年輕人有氣魄！不俗！老朽欣賞你！」 `[用力拍肩]`：「明日馬車，算我的！你和你表妹，還有那位胖道長朋友，一併上路，車錢全免！」
        **Sequence SetPortrait(NPC2,pic=overjoyed);** // 假設村長有對應立繪
        **雍仔 (MC20): [panel=2]** `[突然冒出來，喜形於色]`：「嘿嘿，燕兄弟夠朋友！夠意思！這下咱們的路費都省啦！」 // 假設雍仔此時在場或被提及後出現
        **Sequence SetPortrait(MC20,pic=delighted_or_excited);**
        **旁白**: [PANEL=6]＊[即時訊息區]: 雍仔對你的好感度提升了！＊ // 具體指令待確認，此處為文字描述
        // **[遊戲指令：雍仔(MC20)好感度提升]** (例如: ModifyData(Favor,MC20,Player,10); )
        **蕭靈犀: [panel=1]** `[震驚又心疼]`：「表哥…三百文就這麼送出去了…」 // 蕭靈犀回到panel 1
        **Sequence SetPortrait(MC8,pic=surprise);EnableCharacterExpression(1,MC8,Shock);**
        **燕不凡:** `[努力維持大俠風度]`：「無妨，助人為樂嘛。」
        **Sequence DisableCharacterExpression(1);SetPortrait(MC1,pic=proud);**
        **燕不凡:** `[低聲碎碎念立繪]`：「希望這位道長靠譜點…」
        **Sequence SetPortrait(MC1,pic=tired);EnableCharacterExpression(0,MC1,Meditate);**
        **Sequence DisableCharacterExpression(0);**
        // [主線任務更新，可選回客棧等待或繼續探索]
        // [結束互動]
...
**(若選擇B: 「相逢有緣，村長若需此解法，出個價便可。」)**
        ...
        **Sequence SetPortrait(MC1,pic=serious);**
        **村長 (NPC2):** `[點頭立繪]`：「也好。老朽出一百五十文，買你的解法，如何？」
        **Sequence SetPortrait(NPC2,pic=fair_offer);** // 假設村長有對應立繪
        **蕭靈犀:** `[眼睛一亮]`：「一百五！好耶！表哥快答應！」
        **Sequence SetPortrait(MC8,pic=happy);EnableCharacterExpression(1,MC8,Surprise_2);**
        **旁白**: [PANEL=6]＊獲得：150錢＊
        **Sequence ModifyData(Money,Player,150);** // 假設有這樣的指令
        **燕不凡:** `[略顯平靜]`：「成交。」
        **Sequence DisableCharacterExpression(1);SetPortrait(MC1,pic=serious);**
...
**(若選擇C: 「[口才 難度12] 此解法精妙，晚輩也是費了番心神。看村長也是愛棋之人，不知村長願出何價交換？」)**
        ...
        *   **成功則：**
            ...
            **村長 (NPC2):** `[捋鬚沉吟]`：「嗯…此解法確是難得…」 `[下定決心]`：「也罷！看你我投緣，四百文！老朽的私房錢都給你了！」
            **Sequence DisableCharacterExpression(0);SetPortrait(NPC2,pic=generous_offer);** // 假設村長有對應立繪
            **旁白**: [PANEL=6]＊獲得：400錢＊
            **Sequence ModifyData(Money,Player,400);**
            **旁白**: [PANEL=6]＊[即時訊息區]: 口才檢定成功！口才經驗+10。＊
            **蕭靈犀:** `[驚訝捂嘴]`：「哇！四百文！表哥太厲害了！發財了！可以吃好多頓綠豆糕了！」
            **Sequence SetPortrait(MC8,pic=surprise);EnableCharacterExpression(1,MC8,Shock);**
            **燕不凡:** `[強裝鎮定但得意]`：「咳咳，小場面。」
        ...
        *   **失敗則：**
            **Sequence IsPassDice() == false;**
            **村長 (NPC2):** `[搖頭立繪]`：「年輕人，這解法雖好，但獅子大開口可不好。老朽最多出一百五十文。不願就算了。」 `[略顯不悅]`
            **Sequence DisableCharacterExpression(0);SetPortrait(NPC2,pic=displeased);** // 假設村長有對應立繪
            **旁白**: [PANEL=6]＊[即時訊息區]: 口才檢定失敗。＊
            **蕭靈犀:** `[失望立繪]`：「唉…」
            **Sequence SetPortrait(MC8,pic=dislike);**
            // [返回選項 A, B, D] (或者當前選項C失效，讓玩家重選其他)

**(若選擇D: 「不了，此解法精妙，晚輩還想自行參詳一番。」)**
        **燕不凡:**：「多謝村長美意。不過此棋局解法精妙絕倫，晚輩還想自行再參詳一番，暫不作交換了。」
        **Sequence SetPortrait(MC1,pic=Meditate);**
        **村長 (NPC2):** `[略顯失望]`：「唉，那可惜了…人各有志。」
        **Sequence SetPortrait(NPC2,pic=disappointed);** // 假設村長有對應立繪
        **蕭靈犀:** `[不解]`：「表哥？為什麼不換呀？錢不夠怎麼辦？」
        **Sequence SetPortrait(MC8,pic=dislike);EnableCharacterExpression(1,MC8,Question);**
        **燕不凡:** `[高深莫測]`：「此解法或許另有玄機，不可輕易示人。」
        **Sequence DisableCharacterExpression(1);SetPortrait(MC1,pic=Meditate);**
        **燕不凡:** `[低聲碎碎念立繪]`：「萬一是絕世武功秘籍呢？」
        **Sequence SetPortrait(MC1,pic=tired);EnableCharacterExpression(0,MC1,Meditate);**
        **Sequence DisableCharacterExpression(0);**
        // [結束互動]
