...
>
> **為什麼一定要有那一格：選項是選單，不是台詞本體。** 玩家真正在對話框裡看見主角把話說出口的，是下面那一格；少了它，對方等於在回應一句沒說完的話。**2026-09-05 獨立重掃（覆核首次盤點的 775／278）：全案 956 個選單選項，套下方豁免後缺發言格 142 處**——漏成這樣，就是因為本節的規矩以前只寫在「有檢定」那條流程底下。**✅ 同日全部補完**：作者逐條核可後補上 96 個新發言格（30 份 JSON）＋填 1 個既有空節點，另 29 處「選項與發言格逐字相同」把發言格寫長；未補的是 26 處〔非主角〕與 21 處〔豁免〕。完工紀錄與逐條驗收表見 `劇情/選項盤點_補發言格清單.md`。
>
> **選項文字怎麼寫：**
