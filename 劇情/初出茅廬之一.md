...
*   **(若玩家金錢 >= 300文):**
    ...
    *   **(若選擇1: 「決定了！我們就在此住下！」)**
        ...
        **旁白:**：[panel=6]＊（就在兩人準備邁步走向客棧時，蕭靈犀突然停下了腳步，低頭看向路邊。）＊

        **蕭靈犀:** `[好奇立繪]`：[panel=2]「咦？表哥你看，這路邊怎麼有隻青蛙，而且…牠好像還戴著一頂小草帽？」
        **Sequence SetPortrait(MC8,pic=surprise);EnableCharacterExpression(1,MC8,Question);**

        **短命二郎 (青蛙NPC):** `[露出看似核善的笑容]`：「呱！小丫頭眼力不錯。老子行不更名坐不改姓，乃是水泊梁山一百零八好漢之一，『短命二郎』是也！」

        **燕不凡:** `[疑惑立繪]`：「……一隻會說話的青蛙？還自稱好漢？」
        **Sequence SetPortrait(MC1,pic=confuse);EnableCharacterExpression(0,MC1,Question);**

        **短命二郎 (青蛙NPC):** `[咧嘴一笑，眼神透著兇光]`：「呱呀！小兄弟說話客氣點！老子這雙手渾如鐵棒，兩隻眼有似銅鈴。面皮上常有些笑容，心窩裡深藏著鴆毒！想當年，老子拳打來，獅子心寒；腳踢處，蚖蛇喪膽！江湖上誰不稱我一聲『行瘟使者』！」

        **燕不凡:** `[傻眼立繪]`：「（這隻青蛙是怎麼回事…滿口黑話，也太兇了吧！？）」
        **Sequence SetPortrait(MC1,pic=shock);EnableCharacterExpression(0,MC1,Shock);**

        **蕭靈犀:** `[完全沒被嚇到，友善/感興趣立繪]`：[panel=2]「哇，你好厲害喔！可是你怎麼會在這裡呀？」
        **Sequence SetPortrait(MC8,pic=happy);EnableCharacterExpression(1,MC8,Meditate);**

        **短命二郎 (青蛙NPC):** `[氣勢一收，嘆了口蛙氣]`：「呱…別提了。我那兩個兄弟『立地太歲』和『活閻羅』在小溪村附近走散了，不知去向。你們若能在這小溪村附近幫我尋回那兩位兄弟，我們青蛙好漢絕不虧待朋友！」

        **短命二郎 (青蛙NPC):** `[再次露出陰險的笑容]`：「能生橫禍，善降非災。幫了老子，就是你們的福氣！作為見面禮，這個情報先免費送你們：只要你們在各處找到我們其他青蛙兄弟，收集到一定數量，就能從我們這獲得豐厚的禮物，還有獨家的『江湖秘聞』情報喔！呱！」

        **蕭靈犀:** `[眼睛一亮立繪]`：[panel=2]「禮物！情報！好耶！二郎先生，我們交定你這個朋友了！表哥，我們之後也幫幫牠們吧！」
        **Sequence SetPortrait(MC8,pic=surprise);EnableCharacterExpression(1,MC8,Surprise_2);**

        **燕不凡:** `[無奈但微笑]`：「看來我們的江湖路又多了一樁趣事。也罷，助人為快樂之本！不過眼下…還是先進客棧安頓吧。」
        **Sequence SetPortrait(MC1,pic=smile);ModifyData(Coin,MC1,-300);**

        **蕭靈犀:** `[開心雀躍立繪]`：[panel=2]「太好了！現在總算有個落腳的地方了！不知道客棧的飯菜好不好吃…那位老闆娘…真的像朵花嗎？」
        **Sequence SetPortrait(MC8,pic=happy);EnableCharacterExpression(1,MC8,Surprise_2);**
        **旁白:**：[panel=6]＊（你們深吸一口氣，推開了「有間客棧」的門。門後的景象與那位傳說中的「一枝花」老闆娘，都將在你們安頓下來後逐一揭曉。小溪村的初步探索暫告一段落，接下來的一個月，又會有怎樣的奇遇等待著你們呢？勞碌奔波總算有了個結果，你們決定先好好休息一晚。）＊
        **Sequence DisableCharacterExpression(1);**
        **[第一幕結束 - 標準結局達成]**
