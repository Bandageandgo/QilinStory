...
> **⚠ 黑血屍改動已套入本文。** 取鼎、旅店夢、期限、屍丹（無娜娜）、【她來拿】以本文為準。有娜娜那版見 `劇情/赫連娜娜.md`。數值見 `劇情/骰子場次_數值待定名單.md`。
...
| 地點：有間客棧 - 客棧大廳 |
| :---- |
| 觸發：179年7月上旬 - 8月上旬，主角傷癒後，探險-小溪村時機率觸發 |
...
**(若選擇 1)** 自己拿。跳過檢定。接「銅鼎離開石台」。

**你:** 「好吧。我去看看。」
**旁白:**：[panel=6]＊（你走向石台，把銅鼎拿了起來。）＊

**(若選擇 2)** 接下面魅力檢定。過兩次 → 雍仔自己拿。沒過 → 他被說服、自己拿。兩邊都破封、同一場戰鬥。
...
**少女:** `[聲音稚嫩卻帶著一絲與年齡不符的冰冷與傲慢，僅你能聽見]`：「哼，此等不入流的小妖也膽敢碰吾？」
...
**黑血師 (NPC11):** ：[panel=1]「[em7]獰笑霎時僵住，聲音陡然變調[/em7]，住…住手！那是吾的——！」
**旁白:**：[panel=6]＊（黑血屍猛地抽回手爪，踉蹌後退。牠周身那層盤繞黑氣竟似乎淡了幾分。）＊
> **[系統]** 她吃了一口。某項能力最大值抬高——數值見 `劇情/骰子場次_數值待定名單.md` #1。開對應命盤。主角昏著，不知。
...
**(逃出古墓，回到小溪村)**
**旁白:**：[panel=6]＊（三人一口氣跑出古墓，重見天日，方才鬆了口氣。黑血師並未追出，似乎對外面有所忌憚，又或是被那迷煙所擾。你只覺得頭痛欲裂，眼前發黑，剛才那少女現身的情景如同幻夢般消散，緊接著便失去了所有知覺。）＊
...
**旁白:**：[panel=6]＊（你感覺自己像被扔進了滾燙的油鍋，又像是墜入了冰冷的深淵。無數奇異的景象在眼前閃爍，耳邊充斥著嘈雜的聲音，身體時而灼熱如火，時而冰冷如鐵。……痛楚之中神智迷糊，你只覺一股溫和真氣從外送入，走得極慢極緩。所過之處，體內那些狂暴的異力非但不讓，竟被一點點逼了開去。）＊
...
> **⚠ 說話者一律「少女」。** 好處只點一句，不說是什麼。無分支。不評取鼎。
...
**你:** 「怎麼還能坐在這裡跟大叔說話？」
**旁白:**：[panel=6]＊（傷口還在，只是癒合得快，快得沒有道理。）＊
**你:** 「罷了。大難不死，必有後福——書上都這麼寫。」
> **⚠ 這三句不得寫成「變強」。** 他感覺到的只有沒死、好得快。她撐開的那一塊只有張仲景摸得出來。
...
**旁白:**：[panel=6]＊（你依言盤膝，去尋體內那口氣。只覺一股氣流自足底升起，流經各大脈絡，終匯於丹田，宛如百川之歸大海。）＊
...
**旁白:**：[panel=6]＊（他只是看了你懷裡一眼，很快又把目光移開。）＊
**Sequence DisableCharacterExpression(1);**
...
| 地點：有間客棧 → 村口 |
| :---- |
| 觸發：期限日（馬車出發當日清晨）。前提：第二次尚未入墓。若玩家在期限前自己走進古墓，這場不觸發。 |

> **對齊：** `劇情/小溪村/@結局_序章失敗.md`【被遺忘的災厄】＝傷癒後直至期限，未曾再入墓。原先是逾時自動掉，現改成馬車將發那一天把選擇攤在桌上。
...
**你:** 「不把它了結，我睡覺都不安穩。靈犀在村口等。這次……不會像上次那樣。」

> **代價：** 可能第二次戰死（既有【力竭的英雄】＝遊戲結束）。骰子不會再擋——第一次那一下他沒選，這一次他得自己打。

**(若選擇 2：走)**

**你:** ：「[em7]望了後山一眼，還是把腳邁向馬車[/em7]……英豪府，才是咱們的去處。走吧。」
...
> **→ 接既有【被遺忘的災厄】後文。** 人還在，路還在，英豪府趕得上。村子沒了。雍仔、赫連娜娜（若已觸發）這條伴不跟了。屍丹沒拿到。
...
> **⚠ 四軸不當選項標題。** 後台若要記：1≈信義，2≈通達，3≈仁心，4≈機略。**這一場她一口都吃不到。** 「給她」不是當場選項。珠子保管用 Flag，不要 `AddItem`（ID 待定）。有娜娜那版見 `劇情/赫連娜娜.md`。
...
**(若選擇 1：道長拿著)**
    ...
    **你:** 「且聽說書先生說的武林話本，也沒聽過哪個大俠吃屍丹的，唉，怎不是留下個甚麼千年靈芝之類的，這玩意兒黑不溜秋的，看著就倒胃口…」
    **Sequence SetPortrait(MC1,pic=tired);**
    **雍仔 (MC20):** `[點頭贊許]`：「兄弟果然高義！貧道定會妥善處置此物。」
    **Sequence SetPortrait(MC20,pic=proud);**
    **旁白:**：[panel=6]＊（骰子慢慢涼了。像有人把臉從珠子上挪開。）＊

**(若選擇 2：先收著換錢)**
    **你:** 「道長，此物既然奇特，不如我們先帶上，日後到了大城鎮，找個行家鑑定一番，再決定如何處置？」
    **Sequence SetPortrait(MC1,pic=Meditate);**
    **雍仔 (MC20):** `[沉吟片刻]`：「嗯…此法倒也穩妥。」
...
**(若選擇 3：當場毀了)**
    ...
    **旁白:**：[panel=6]＊（你懷裡那顆骰子涼了下來。）＊
    > **[系統]** 不給數值。珠子確實毀了，任何人都沒拿到，她也沒吃到。舊稿「黑氣拐彎被吸乾」已刪，不得復原。

**(若選擇 4：我自己收著)**
    **你:** 「道長放心！便由我暫為保管。」
    **Sequence SetPortrait(MC1,pic=proud);ModifyData(Valuable,Player,CorpsePearl,1);**
    **雍仔 (MC20):** `[面露憂色]`：[panel=1]「兄弟，此物非同小可…」
...
### 10b. 【她來拿】（客棧夜．前提：屍丹在主角身上）
| 地點：有間客棧 - 主角房間 |
| :---- |
| 觸發：選了屍丹選項 4 之後、離開小溪村前的任一夜。珠子仍在身上。 |

> **⚠ 她不開口要。** 伸不伸手是他的事。說話者一律「少女」。
...
**旁白:**：[panel=6]＊（懷裡熱了一下。你伸手去按，按到的不是骰子，是旁邊那顆從黑血屍身上得來的屍丹。）＊
**你:** ：「這個？」
**少女:** ：[panel=1]「你留著也吃不了。」
...
> **⚠ 兩條台詞不同，她的回答一個字都不變，之後合流。** 後台若要記：1≈信義，2≈機略。只表態、無後果，取常規量 0.2。

**(A)**
**你:** ：「墓裡那一回，要不是妳出手，我早沒了。這事我一直記著。」
...
**(1：給)**
**你:** ：「便給妳罷。妳既看著它，若我還捨不得，那可顯得太吝嗇了。」
**旁白:**：[panel=6]＊（你探手入懷。那顆珠子已在掌心，還帶著體溫。）＊
**旁白:**：[panel=6]＊（她伸手拿了過去，倒像拿回一件本來就屬於她的東西。你的手還停在原處，掌心已經空了，珠子在她手裡也沒了。）＊
...
**你:** ：「……沒有。睡罷。」
> **[系統]** 她吃了。該項能力最大值抬高——數值見名單 #3。屍丹移除。不擲「她停不停得下來」。

**(2：不給)**
**你:** ：「這是我拼命換來的。吃不了，也是我的。」
**旁白:**：[panel=6]＊（她看了你一會兒，把目光挪開了。不是動怒——倒像是把一件本就沒興趣的東西，隨手放回了原處。）＊
